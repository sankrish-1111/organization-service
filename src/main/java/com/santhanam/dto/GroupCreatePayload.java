...
public class GroupCreatePayload {
    ...
    public GroupCreatePayload(String parentUuid, String name, String displayName, GroupStatus status, String spaceId, String location, String language, List<String> segments) {
    ...
    public static class Builder {
        ...
        public GroupCreatePayload build() {
            return new GroupCreatePayload(parentUuid, name, displayName, status, spaceId, location, language, segments);
        }
    }
}